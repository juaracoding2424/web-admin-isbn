                        ...
                        <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                            ...
                            <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                                ...
                                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                                    ...
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <li class="breadcrumb-item text-muted">Surat</li>
                                    <!--end::Item-->
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                        ...
                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#modal_surat"
                                    class="btn btn-primary fw-bold fs-8 fs-lg-base" onclick="newSurat()">Buat Surat</a>
                            </div>
                            <!--end::Card toolbar-->
                        </div>
                        <!--end::Card header-->
                                ...
                                <table class="table table-row-dashed table-hover no-wrap fs-8 gy-5" id="example"
                                    ...
                                    <thead>
                                        <tr class="text-start text-gray-500 fw-bold fs-8 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-225px">Deskripsi Dokumen</th>
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="form" class="form" action="#">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Buat Template Surat</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                        <div class="text-gray-500 fw-semibold fs-5">Daftar template surat untuk keperluan pendaftaran ISBN atau akun penerbit</div>
                        <!--end::Description-->
                    </div>
                    <!--end::Heading-->
                    <!--begin::Input group-->
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                            <span class="required">Judul Dokumen</span>
                            <span class="ms-2" data-bs-toggle="tooltip" title="Tuliskan judul dokumen">
                                <i class="ki-outline ki-information fs-7"></i>
                            </span>
                        </label>
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" placeholder="Masukan judul dokumen"
                            name="title" />
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    ...
                    <div class="fv-row mb-8">
                        ...
                        <!--begin::Dropzone-->
                        <div class="dropzone" id="surat_attachments">
                            <!--begin::Message-->
...
<script>
    var surat = [
        {
            name:"Surat Pernyataan Penerbit",
            description : "Dokumen resmi yang diperlukan saat mendaftarkan akun penerbit pada aplikasi ISBN. Dokumen ini berfungsi untuk menegaskan keabsahan dan kredibilitas penerbit yang mendaftar, serta memastikan bahwa penerbit tersebut memenuhi syarat dan ketentuan yang ditetapkan oleh Perpusnas",
            attachment:"/assets/files/docsurat_Surat Pernyataan Penerbit - 20220813.docx",
            nama_file : "<i class='fa-solid fa-file-word fs-2' tooltip='true' title='Surat Pernyataan Penerbit'></i>"
        },
        {
            name:"Surat Pernyataan Keaslian Karya",
            description : "Surat Keaslian Karya adalah dokumen resmi yang menyatakan bahwa sebuah karya tertentu, baik itu dalam bentuk tulisan, seni, penelitian, atau produk lainnya, adalah hasil asli dan tidak melanggar hak cipta atau hak kekayaan intelektual pihak lain",
            attachment:"/assets/files/docsurat_Surat Keaslian Karya - 20221027.docx",
            nama_file : "<i class='fa-solid fa-file-word fs-2' tooltip='true' title='Surat Pernyataan Keaslian Karya'></i>"
        },
    ];
   
    var populateDataSet = function (dataSurat) {
        var dataSetPop = [];
        let i = 1;
        dataSurat.forEach(function (item, index) {
            dataSetPop.push([
                '<span id="dataID_'+(i-1)+'">' + (i).toString() +"</span>",
                '<span id="title_'+(i-1)+'">'+surat[i-1].name+'</span>',
                '<span id="description_'+(i-1)+'">' + surat[i-1].description + '</span>',
                '<a id="attachment_'+(i-1)+'" href="'+surat[i-1].attachment+'">' + surat[i-1].nama_file + '</span>',
    ...
    const dataSet = populateDataSet(surat); var table;

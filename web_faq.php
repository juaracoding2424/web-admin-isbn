					...
					<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
						...
						<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
							...
							<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
								...
								<!--end::Item-->
								<!--begin::Item-->
								<li class="breadcrumb-item text-muted">Semua pengguna</li>
								<!--end::Item-->
							</ul>
							<!--end::Breadcrumb-->
						</div>
				...
				<div id="kt_app_content_container" class="app-container container-fluid">
					...
					<div class="card card-flush">
						...
						<div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            ...
                            <a href="#" data-bs-toggle="modal" data-bs-target="#modal_faq" class="btn btn-primary fw-bold fs-8 fs-lg-base" onclick="newFaq()">Buat FAQ</a>
                            </div>
                        <!--end::Card toolbar-->
						</div>
						<!--end::Card header-->
												...
												<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
													...
													<form id="form_faq" class="form" action="#">
														...
														<div class="mb-13 text-center">
															...
															<!--end::Title-->
															<!--begin::Description-->
															<div class="text-gray-500 fw-semibold fs-5">Daftar pertanyaan dan jawaban yang sering diajukan tentang topik tertentu</div>
															<!--end::Description-->
														</div>
														<!--end::Heading-->
														<!--begin::Input group-->
														<div class="d-flex flex-column mb-8 fv-row">
															...
															<!--end::Label-->
															<input type="text" class="form-control form-control-solid" placeholder="Masukan kategori FAQ" name="category" />
														</div>
														<!--end::Input group-->
														<!--begin::Input group-->
														<div class="d-flex flex-column mb-8 fv-row">
															...
															<!--end::Label-->
															<input type="text" class="form-control form-control-solid" placeholder="Masukan pertanyaan untuk FAQ" name="question" />
														</div>
														<!--end::Input group-->
														<!--begin::Input group-->
														<div class="d-flex flex-column mb-8 fv-row">
															<label class="fs-6 fw-semibold mb-2">Jawaban</label>
															<textarea class="form-control form-control-solid" rows="4" name="answer" placeholder="Masukan jawaban dari FAQ"></textarea>
														</div>
														<!--end::Input group-->
														<!--begin::Input group-->
														...
														<div class="row g-9 mb-8">
															...
															<div class="col-md-6 fv-row">
																...
																<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Pilih status FAQ" name="status">
...
<script>
	...
	var populateDataSet = function(dataFaq, dataDetail){
		...
		dataFaq.forEach(function(item, index){
			dataSetPop.push([
				...
				item.q,
                item.a,
                '<select class="form-select fs-7 select-costum" id="changeStatus_'+index+'" onChange="changeStatus('+index+')"><option value"">--Pilih status--</option><option value="publish">Publish</option><option value="hide">Hide</option></select>', 
				'<a class="badge badge-info h-30px m-1" onclick="edit('+index+')" href="#" data-bs-toggle="modal" data-bs-target="#modal_faq">Ubah</a> <a class="badge badge-danger h-30px m-1" onclick="hapus('+index+')" href="#">Hapus</a>',
			]);
		});
	...
	var edit = function(index){
        ...
        $(i.querySelector('[name="category"]')).val(dataSet[index][1]);
        $(i.querySelector('[name="question"]')).val(dataSet[index][2]);
        $(i.querySelector('[name="answer"]')).val(dataSet[index][3]);
    ...
    var hapus = function(index){
		...
		let position = arrNomor.indexOf((index+1).toString());
                    ...
                    e.preventDefault(), n && n.validate().then((function(e) {
                        console.log("validated!"), "Valid" == e ? (t.setAttribute("data-kt-indicator", "on"), t.disabled = !0, setTimeout((function() {
                            if($(i.querySelector('[name="dataID"]')).val() == ""){
                                ...
                                dataSet[idx][1] = $(i.querySelector('[name="category"]')).val();
                                dataSet[idx][2] = $(i.querySelector('[name="question"]')).val();
                                dataSet[idx][3] = $(i.querySelector('[name="answer"]')).val();

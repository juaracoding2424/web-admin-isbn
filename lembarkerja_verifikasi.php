					...
					<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
						...
						<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
							...
							<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
								...
								<!--end::Item-->
								<!--begin::Item-->
								<li class="breadcrumb-item text-muted">Verifikasi permohonan ISBN</li>
								<!--end::Item-->
							</ul>
							<!--end::Breadcrumb-->
						</div>
								...
								<div class="card min-w-full">
									<div class="card-header">
										<h3 class="card-title text-gray-800 text-hover-primary fs-2 fw-bold me-3">
											General Info <span class="badge badge-light-success me-3">Tersisa  67  permohonan ISBN yang perlu diverifikasi</span>
										</h3>
										<div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3 m-3">
											<!--begin::Number-->
											<div class="d-flex align-items-center">
												<div class="fs-4 fw-bold">Nomor Antrian</div>
											</div>
											<!--end::Number-->
											<!--begin::Label-->
											<div class="fw-semibold fs-2x text-info fw-bold text-center">31</div>
												<!--end::Label-->
										</div>
									</div>
												...
												<div class="card-body border-top p-9">
																...
																<div class="col-md-6 col-lg-12 col-xxl-6">
																	<label class="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex text-start p-6" data-kt-button="true">
																		...
																		<span class="ms-5">
																			...
																			<span class="fw-semibold fs-7 text-gray-600">Penerbit akan mendapatkan notifikasi verifikasi permohonan ISBN</span>
																		</span>
																	</label>
																</div>
																<!--end::Col-->
																...
																<div class="col-md-6 col-lg-12 col-xxl-6">
																	<label class="btn btn-outline btn-outline-dashed btn-active-light-danger d-flex text-start p-6" data-kt-button="true">
																		...
																		<span class="ms-5">
																			...
																			<span class="fw-semibold fs-7 text-gray-600">Anda wajib memasukan alasan permohonan ISBN bermasalah</span>
																		</span>
																	</label>
																</div>
																<!--end::Col-->
													...
													<div class="row mb-6" style="display:none" id="divMasalah">
														...
														<label class="col-lg-3 col-form-label fw-semibold fs-6">
															...
															<span class="ms-1" data-bs-toggle="tooltip" title="Isi deskripsi masalah untuk menolak permohonan ISBN">
																<i class="ki-outline ki-information-5 text-gray-500 fs-6"></i>
															</span>
														</label>
														<!--end::Label-->
														<!--begin::Col-->
														<div class="col-lg-9 fv-row">
                                                            <textarea  row="5" type="text" name="problem" class="form-control form-control-lg form-control-solid" placeholder="Isi deskripsi masalah permohonan ISBN"></textarea>
														</div>
														<!--end::Col-->
													</div>
													<!--end::Input group-->

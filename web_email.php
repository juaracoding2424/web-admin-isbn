            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="form" class="form" action="#">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" placeholder="Masukan judul berita / pengumuman"
                            name="title" />
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true"
                                data-placeholder="Pilih status berita / pengumuman" name="status">
...
<script src="assets/js/custom/lorem.js"></script>
...
<script>   
    ...
    const dataSet = populateDataSet(Lorem.prototype.randomInt(5,20)); 
    var table;
    ...
    var hapus = function (index) {
        r = $('#title_' + index).text();
        Swal.fire({
            html: "Anda yakin akan menghapus berita/pengumuman: <span class='badge badge-info'> " + r + "</span>",
            icon: "warning",
            showCancelButton: !0,
            buttonsStyling: !1,
            ...
            if (e.isConfirmed == true) { //kalau ok
                Swal.fire({
                    html: "Anda menghapus berita/pengumuman: <span class='badge badge-info'>" + r + "</span>!.",
                    icon: "success",
                    buttonsStyling: !1,
    ...
    var changeStatus = function (selectId) {
        ...
        //
        Swal.fire({
            html: "Berhasil mengubah status berita / pengumuman menjadi " + val,
            icon: "success",
            timer: 1000,
            customClass: {
                confirmButton: "btn fw-bold btn-primary"
                    ...
                    $(i.querySelector('[name="title"]')).on("change", (function () {
                        ...
                        fields: {
                            ...
                            description: {
                                validators: {
                                    notEmpty: {
                                        message: "Deskripsi berita tidak boleh kosong!"
                                    }
                                }
                            },
                            status: {
                        ...
                        e.preventDefault(), n && n.validate().then((function (e) {
                            console.log("validated!"), "Valid" == e ? (t.setAttribute("data-kt-indicator", "on"), t.disabled = !0, setTimeout((function () {
                                if ($(i.querySelector('[name="dataID"]')).val() == "") {
                                    ...
                                    var text = "Berita / pengumuman telah ditambahkan!";
                                    table.destroy();
                                    loadDataTable();
                                } else {
                                    ...
                                    var text = "Berita / pengumuman berhasil diubah!";
                                }
                        ...
                        t.preventDefault(), Swal.fire({
                            text: "Apa anda yakin membatalkan tambah/edit berita?",
                            icon: "warning",
                            showCancelButton: !0,
                            buttonsStyling: !1,
                            ...
                            t.value ? (i.reset(), o.hide()) : "cancel" === t.dismiss && Swal.fire({
                                text: "Pembatalan berita/pengumuman tidak jadi dilakukan.",
                                icon: "error",
                                buttonsStyling: !1,
                                confirmButtonText: "Ok, got it!",
                                customClass: {
